...
for %%G in (HaleyHelpers.DB HaleyHelpers.Web HaleyWorkFlow HaleyWorkFlow.API HaleyHelpers HaleyRest HaleyExtensions HaleyLog HaleyWPF HaleyMVVM HaleyIOC HaleyWPFIconsPack HaleyVue HaleyAbstractions HaleyRuleEngine HaleyEvents HaleyXamlShared HaleyVSIX HaleyWPFFonts HaleyLifeCycle HaleyFlow.Base HaleyFlow.Hub HaleyFlow.Agent) do ((echo %%G) && (git clone https://github.com/TheHaleyProject/%%G))
pause