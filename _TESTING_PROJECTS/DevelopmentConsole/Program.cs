...
namespace DevelopmentConsole
{
    ...
    public class Program
    {
        static void Main(string[] args)
        {
            ...
            var _person2 = _di.Resolve<Person>(GenerateNewInstance.TargetOnly); //Should return SS. Since, targetonly ensures that the target "Person" is created as instance where as it's dependencies are not.
            Console.WriteLine(_person2._power.name);
            var _person3 = _di.Resolve<Person>(GenerateNewInstance.AllDependencies); //Should return batman
            ...
            var _person5 = _di.Resolve<Person>(_mpb, GenerateNewInstance.AllDependencies); //Should return batman
